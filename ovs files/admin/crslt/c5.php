...
$pres2 = $_POST["tot2"];
include("../../../conn.php");
$qry = mysqli_query($conn, "UPDATE c_trsr SET aspirant1='$pres1',aspirant2='$pres2'");
if($qry){
header("location:c6.php");
}else{
            ...
            <div class="container-fluid">
				...
				<div class="col-lg-12">
					<div class="table-responsive">					
						...
						<tbody>
						<tr><td>Richard H. </td><td><input type="text" onkeyup="tot1.value=sum(parseFloat(ap11.value),parseFloat(ap12.value),parseFloat(ap13.value),parseFloat(ap14.value),parseFloat(ap15.value));" value="0" name="ap11" /></td><td><input type="text" onkeyup="tot1.value=sum(parseFloat(ap11.value),parseFloat(ap12.value),parseFloat(ap13.value),parseFloat(ap14.value),parseFloat(ap15.value));"  value="0" name="ap12" /></td><td><input type="text" onkeyup="tot1.value=sum(parseFloat(ap11.value),parseFloat(ap12.value),parseFloat(ap13.value),parseFloat(ap14.value),parseFloat(ap15.value));" value="0" name="ap13" /></td><td><input type="text" onkeyup="tot1.value=sum(parseFloat(ap11.value),parseFloat(ap12.value),parseFloat(ap13.value),parseFloat(ap14.value),parseFloat(ap15.value));" name="ap14" value="0"/></td><td><input type="text" onkeyup="tot1.value=sum(parseFloat(ap11.value),parseFloat(ap12.value),parseFloat(ap13.value),parseFloat(ap14.value),parseFloat(ap15.value));" name="ap15" value="0"/></td><td><input readonly type="text" name="tot1" value="0"/></td></tr>
						<tr><td>Peter Lahm </td><td><input value="0" onkeyup="tot2.value=sum(parseFloat(ap21.value),parseFloat(ap22.value),parseFloat(ap23.value),parseFloat(ap24.value),parseFloat(ap25.value));" type="text" name="ap21" /></td><td><input type="text" onkeyup="tot2.value=sum(parseFloat(ap21.value),parseFloat(ap22.value),parseFloat(ap23.value),parseFloat(ap24.value),parseFloat(ap25.value));" value="0" name="ap22" /></td><td><input type="text" onkeyup="tot2.value=sum(parseFloat(ap21.value),parseFloat(ap22.value),parseFloat(ap23.value),parseFloat(ap24.value),parseFloat(ap25.value));" value="0" name="ap23" /></td><td><input type="text" onkeyup="tot2.value=sum(parseFloat(ap21.value),parseFloat(ap22.value),parseFloat(ap23.value),parseFloat(ap24.value),parseFloat(ap25.value));" value="0" name="ap24" /></td><td><input type="text" onkeyup="tot2.value=sum(parseFloat(ap21.value),parseFloat(ap22.value),parseFloat(ap23.value),parseFloat(ap24.value),parseFloat(ap25.value));" name="ap25" value="0"/></td><td><input type="text" name="tot2" value="0"/></td></tr>								
						</tbody>
						</table>
							<center>
							<span id='errmsg'></span>
							<br><br>
							<a href='c4.php'> <input type="BUTTON" value="PREVIOUS"/></a> <input type="submit" value="NEXT" name="save_rec" />
							</center>					
						</form>					
					</div>              
                </div>
