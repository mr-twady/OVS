                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-bar-chart-o"></i> electionsresult
                            </li>
...
?>
				...
				<i>?php
				####$msg = "This result is duly signed and approved by Mr B.Dcalc - Demo Inec Chairman,<br>".date('M-d, Y')."<br>";					
				###echo $msg;
